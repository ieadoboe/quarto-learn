...
<button href="/lessons" class="btn btn-outline-success">Skip to Lessons →</button>
...
<button href="/lessons" class="btn btn-outline-success">Start Learning →</button>

## Feedback?

Got ideas, suggestions, or corrections? [Open an Issue on GitHub](https://github.com/ieadoboe/quarto-learn/issues) or reach out on [X formerly Twitter](https://x.com/ieadoboe).